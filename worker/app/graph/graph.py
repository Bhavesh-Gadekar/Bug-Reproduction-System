...
def make_graph(
    ...
    builder.add_node("repo_analysis", repo_analysis_node)
    builder.add_node("env_setup", env_setup_node)
    builder.add_node("hypothesis_gen", make_hypothesis_gen_node(llm_client))
    builder.add_node("script_gen", make_script_gen_node(llm_client))
    builder.add_node("sandbox_exec", make_sandbox_exec_node(sandbox_client, timeout_seconds=exec_timeout))
    builder.add_node("verdict", verdict_node)
    builder.add_node("minimization", minimization_node)
    ...
    builder.add_edge("env_setup", "hypothesis_gen")
